...
class EmployeeEmployee(models.Model):
    ...
    shift_type = models.ForeignKey('EmployeeShift', models.DO_NOTHING, blank=True, null=True)
...
class EmployeeTicket(models.Model):
    ...
    assigned_to = models.ForeignKey(EmployeeEmployee, models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'employee_ticket'
